  ...
  return (
    <aside className="hidden lg:block w-[300px] flex-shrink-0 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-[calc(var(--navbar-height,60px)+16px)] self-start">
      ...
      <div className="px-4 pt-4 pb-3">
        <p className="text-xs font-bold text-[#008fa6] uppercase tracking-wider mb-3">
          Browse Categories
        </p>
            ...
            <button
              ...
              className={cn(
                ...
                activeCategory === label
                  ? "border-[#008fa6] bg-[#f0fbfc] text-[#008fa6]"
                  : "border-gray-100 bg-gray-50 text-gray-600 hover:border-[#008fa6]/40 hover:bg-[#f0fbfc]/50"
              )}
            >
      ...
      <div className="px-4 pb-4">
        ...
        <AccordionSection title="Brand / Model" defaultOpen>
          <div className="space-y-2">
            <select
              ...
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-600 bg-white focus:outline-none focus:ring-2 focus:ring-[#008fa6]/30 focus:border-[#008fa6] appearance-none cursor-pointer"
            >
            ...
            <select className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-400 bg-white focus:outline-none focus:ring-2 focus:ring-[#008fa6]/30 focus:border-[#008fa6] appearance-none cursor-pointer">
        ...
        <AccordionSection title="Price Range">
          <div className="space-y-2.5">
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#008fa6]/30 focus:border-[#008fa6]"
                />
              </div>
              <div>
            ...
            <button className="w-full bg-[#008fa6] hover:bg-[#007a8f] text-white text-sm font-semibold py-2.5 rounded-xl transition-colors">
              Apply Price
            </button>
          </div>
        </AccordionSection>
          ...
          <div className="space-y-2">
            {["New", "Like New", "Good", "Fair"].map((c) => (
              <label key={c} className="flex items-center gap-2.5 cursor-pointer group">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-300 cursor-pointer accent-[#008fa6]"
                />
        ...
        {/* Reset button */}
        <button className="w-full mt-3 text-sm text-gray-400 hover:text-[#008fa6] underline-offset-2 hover:underline transition-colors">
          Reset all filters
        </button>
      </div>
    </aside>
